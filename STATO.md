...
- **Chiarito il 13/09**: DISH e Lieferando sono **concorrenti**, non collegati (Metro ha creato DISH apposta per competere con le commissioni alte di Lieferando — fonte: food-service.de). L'utente conferma: **usa solo Lieferando** in pratica; l'account DISH non risulta attivo/pagato (nessun addebito trovato) — probabilmente aperto (dati veri dal POS) ma mai davvero attivato/sottoscritto. Quindi ad oggi **nessun canale a basso costo è realmente attivo**: solo Lieferando (commissione 13-30%). GloriaFood (gratis/~25€ mese) resta l'opzione più economica se si vuole un canale diretto, ma va comunque costruita da zero — non è "già pronta" come DISH sembrava essere.
